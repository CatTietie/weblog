...
import { c as gl, C as fl, e as hl, a as bl, u as vl, b as kl, d as Cl, f as pl, g as $l, h as yl, i as Tl, M as wl } from "./chunks/index.mjs";
...
const Al = /* @__PURE__ */ P({
  ...
  setup(e) {
    ...
    const C = we(() => {
      const b = e.toolbars.filter((I) => !e.toolbarsExclude.includes(I)), p = b.indexOf("="), T = p === -1 ? b : b.slice(0, p + 1), S = p === -1 ? [] : b.slice(p, Number.MAX_SAFE_INTEGER);
      return [T, S];
    }), d = U(), k = () => {
    ...
    const f = (b) => {
      var p, T, S, I, D, oe, ae, M, L, _, W, O, N, B, V, K, j, de, ne, J, Z, ie, X, F, R, re, me, Ae, Me, Le, Ie, De, Ee, He, Ne, Be, Oe, Ve, Fe, Re, Pe, We, Ue, _e, qe, ze, Ge, Ke, je, Ze, Xe, Ye, Je, Qe, et, tt, lt, ot, at, nt, it, rt, st, ct, ut, dt, mt;
      if (Ut.includes(b))
        switch (b) {
          case "-":
          ...
          case "bold":
            return t("div", {
              ...
              title: (p = l.value.toolbarTips) == null ? void 0 : p.bold,
              onClick: () => {
                s("bold");
              }
            }, [t(y, {
          ...
          case "title":
            return t(se, {
              ...
              default: () => {
                ...
                return [t("div", {
                  class: `${n}-toolbar-item`,
                  title: ($ = l.value.toolbarTips) == null ? void 0 : $.title
                }, [t(y, {
                  name: "title"
                }, null), e.showToolbarName && t("div", {
                  class: `${n}-toolbar-item-name`
          ...
          case "image":
            return e.noUploadImg ? t("div", {
              ...
              default: () => {
                ...
                return [t("div", {
                  class: `${n}-toolbar-item`,
                  title: ($ = l.value.toolbarTips) == null ? void 0 : $.image
                }, [t(y, {
                  name: "image"
                }, null), e.showToolbarName && t("div", {
                  class: `${n}-toolbar-item-name`
          ...
          case "table":
            return t(se, {
              ...
              default: () => {
                ...
                return [t("div", {
                  class: `${n}-toolbar-item`,
                  title: ($ = l.value.toolbarTips) == null ? void 0 : $.table
                }, [t(y, {
                  name: "table"
                }, null), e.showToolbarName && t("div", {
                  class: `${n}-toolbar-item-name`
          ...
          case "mermaid":
            return t(se, {
              ...
              default: () => {
                ...
                return [t("div", {
                  class: `${n}-toolbar-item`,
                  title: ($ = l.value.toolbarTips) == null ? void 0 : $.mermaid
                }, [t(y, {
                  name: "mermaid"
                }, null), e.showToolbarName && t("div", {
                  class: `${n}-toolbar-item-name`
          ...
          case "katex":
            return t(se, {
              ...
              default: () => {
                ...
                return [t("div", {
                  class: `${n}-toolbar-item`,
                  title: ($ = l.value.toolbarTips) == null ? void 0 : $.katex
                }, [t(y, {
                  name: "formula"
                }, null), e.showToolbarName && t("div", {
                  class: `${n}-toolbar-item-name`
        ...
        const $ = e.defToolbars.children[b];
        return $ ? gt($, {
          theme: a.value,
          language: i.value,
          insert(ke) {
    ...
    return H(() => e.toolbars, () => {
      ...
      const b = C.value[0].map((T) => f(T)), p = C.value[1].map((T) => f(T));
  ...
  if (/^h[1-6]{1}$/.test(e)) {
    const b = e.replace(/^h(\d)/, (p, T) => new Array(Number(T)).fill("#", 0, T).join(""));
    a = `${b} ${u}`, i = b.length + 1;
  } else if (e === "prettier") {
    const b = window.prettier || ((C = (w = Q.editorExtensions) == null ? void 0 : w.prettier) == null ? void 0 : C.prettierInstance), p = [
    ...
    !b || p[0] === void 0 ? (v.emit(l.editorId, le, {
      name: "prettier",
    ...
    switch (e) {
      ...
      case "code": {
        const b = l.text || u || "", p = l.mode || "language";
        a = `\`\`\`${p}
${b}
\`\`\`
`, i = 3, r = 3 + p.length - a.length;
        break;
      }
      case "table": {
        a = "|";
        const { selectedShape: b = { x: 1, y: 1 } } = l, { x: p, y: T } = b;
        for (let S = 0; S <= T; S++)
          a += " col |";
        a += `
|`;
...
|`;
      ...
      case "link": {
        const { desc: b, url: p } = l;
        a = `[${b}](${p})`, m = !1;
        break;
      }
      case "image": {
        const { desc: b, url: p, urls: T } = l;
...
`, i = 3, r = -4;
      ...
      case "universal": {
        const { generate: b } = l, p = b(u);
        a = p.targetValue, m = p.select, i = p.deviationStart, r = p.deviationEnd;
      }
    }
  return {
    text: a,
...
}, zl = "#e5c07b", ht = "var(--md-color)", Gl = "#56b6c2", Kl = "#ffffff", ce = "var(--md-color)", bt = "#e5c07b", jl = "#e5c07b", Zl = "var(--md-color)", vt = "#d19a66", Xl = "#c678dd", Yl = "#21252b", Jl = "#2c313a", kt = "var(--md-bk-color)", pe = "var(--md-bk-color)", Ql = "#ceedfa33", Ct = "#528bff", eo = Se.theme(
  {
    "&": {
      color: ce,
      backgroundColor: kt
  ...
  eo,
  Ot(to)
], lo = "#e5c07b", $t = "#3f4a54", oo = "#56b6c2", ao = "#fff", ue = "#3f4a54", yt = "#2d8cf0", no = "#2d8cf0", io = "#3f4a54", Tt = "#d19a66", ro = "#c678dd", so = "#21252b", co = "#ceedfa33", wt = "var(--md-bk-color)", $e = "var(--md-bk-color)", uo = "#bad5fa", xt = "#3f4a54", mo = Se.theme(
  {
    "&": {
      color: ue,
      backgroundColor: wt
  ...
  { tag: [c.name, c.deleted, c.character, c.propertyName, c.macroName], color: $t },
  ...
  { tag: c.heading, fontWeight: "bold", color: $t },
...
const bo = (e) => {
  ...
  const o = A("tabWidth"), l = A("editorId"), a = A("theme"), i = U(), r = Pt(), m = new be(), g = new be(), u = new be(), s = $o(l, e), h = vo(e), w = [
    ol.of([...s, sl]),
    tl,
  ...
  return Y(() => {
    ...
    r.value = k, setTimeout(() => {
      ...
      callback(f, b = {}) {
        var S;
        const { text: p, options: T } = ql(f, r.value, b);
        (S = r.value) == null || S.replaceSelectedText(p, T, l);
      }
    });
  }), H(
    a,
    () => {
      ...
      (d = r.value) == null || d.view.dispatch({
        effects: g.reconfigure(a.value === "light" ? St : pt)
      });
    },
    {
      deep: !0
  ...
  setup(e, o) {
    ...
    vl(e, o), kl(e), Cl(e), pl(e, o);
    const [s, h] = $l(e, o), w = yl(e);
    return It(() => {
      v.clear(l);
    }), Tl(e, o, w, s, h), () => {
      var k;
