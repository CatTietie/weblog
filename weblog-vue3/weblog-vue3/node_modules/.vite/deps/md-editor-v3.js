import {
  markdown
} from "./chunk-ZDDYLZTK.js";
import "./chunk-JSFFOW4Z.js";
import "./chunk-AUHDNJUB.js";
import "./chunk-XPUVZD47.js";
import {
  autocompletion,
  closeBrackets,
  closeBracketsKeymap,
  completionKeymap
} from "./chunk-LXAN32BM.js";
import {
  Annotation,
  ChangeDesc,
  ChangeSet,
...
var _ = (e4) => {
  const n3 = (t3) => {
    const { scrollHeight: o2, scrollWidth: r4, offsetHeight: c2, offsetWidth: s3, scrollLeft: i4, scrollTop: l2 } = e4, u2 = t3.x, w2 = t3.y, p3 = (g4) => {
      const f3 = l2 + w2 - g4.y, m5 = i4 + u2 - g4.x, S2 = o2 - c2, y2 = r4 - s3, d3 = {};
  ...
  setup(e4, c2) {
    ...
    return onMounted(() => {
      ...
      s3 ? (a2.value.push("zoom-in"), i4.value = s3, nextTick(() => {
        const n3 = m5.value.offsetWidth / 2, u2 = m5.value.offsetHeight / 2, $ = document.documentElement.clientWidth / 2, x2 = document.documentElement.clientHeight / 2;
        o2.initPos.left = $ - n3 + "px", o2.initPos.top = x2 - u2 + "px";
      }), setTimeout(() => {
...
function isAdjacent(a2, b4) {
  ...
  b4.iterChangedRanges((_f, _t, f3, t3) => {
...
function sql(dialectName) {
  return import("./dist-QI2ZCYGT.js").then((m5) => m5.sql({ dialect: m5[dialectName] }));
}
var languages = [
  ...
  LanguageDescription.of({
    ...
    extensions: ["c", "h", "ino"],
    load() {
      return import("./dist-TK2E7LKZ.js").then((m5) => m5.cpp());
    }
  }),
  LanguageDescription.of({
    name: "C++",
  ...
  LanguageDescription.of({
    ...
    extensions: ["css"],
    load() {
      return import("./dist-34UNUNQZ.js").then((m5) => m5.css());
    }
  }),
  LanguageDescription.of({
    name: "HTML",
    ...
    load() {
      return import("./dist-H2IHD6BQ.js").then((m5) => m5.html());
    }
  }),
  LanguageDescription.of({
    name: "Java",
    extensions: ["java"],
    load() {
      return import("./dist-NZXCE6WF.js").then((m5) => m5.java());
    }
  }),
  LanguageDescription.of({
    name: "JavaScript",
    ...
    load() {
      return import("./dist-EIRWYHTK.js").then((m5) => m5.javascript());
    }
  }),
  LanguageDescription.of({
    name: "JSON",
    ...
    extensions: ["json", "map"],
    load() {
      return import("./dist-XB5IGQL5.js").then((m5) => m5.json());
    }
  }),
  LanguageDescription.of({
    name: "JSX",
    extensions: ["jsx"],
    load() {
      return import("./dist-EIRWYHTK.js").then((m5) => m5.javascript({ jsx: true }));
    }
  }),
  LanguageDescription.of({
    name: "LESS",
    extensions: ["less"],
    load() {
      return import("./dist-AQ6JKSP3.js").then((m5) => m5.less());
    }
  }),
  LanguageDescription.of({
    name: "MariaDB SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-JH2IUEVA.js").then((m5) => m5.markdown());
    }
  }),
  LanguageDescription.of({
    name: "MS SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-3JXHQURJ.js").then((m5) => m5.php());
    }
  }),
  LanguageDescription.of({
    name: "PLSQL",
  ...
  LanguageDescription.of({
    ...
    filename: /^(BUCK|BUILD)$/,
    load() {
      return import("./dist-SOLDLILJ.js").then((m5) => m5.python());
    }
  }),
  LanguageDescription.of({
    name: "Rust",
    extensions: ["rs"],
    load() {
      return import("./dist-H4ARRWHP.js").then((m5) => m5.rust());
    }
  }),
  LanguageDescription.of({
    name: "Sass",
    extensions: ["sass"],
    load() {
      return import("./dist-A2F5ECLU.js").then((m5) => m5.sass({ indented: true }));
    }
  }),
  LanguageDescription.of({
    name: "SCSS",
    extensions: ["scss"],
    load() {
      return import("./dist-A2F5ECLU.js").then((m5) => m5.sass());
    }
  }),
  LanguageDescription.of({
    name: "SQL",
  ...
  LanguageDescription.of({
    ...
    extensions: ["tsx"],
    load() {
      return import("./dist-EIRWYHTK.js").then((m5) => m5.javascript({ jsx: true, typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "TypeScript",
    ...
    extensions: ["ts"],
    load() {
      return import("./dist-EIRWYHTK.js").then((m5) => m5.javascript({ typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "WebAssembly",
    extensions: ["wat", "wast"],
    load() {
      return import("./dist-KZ3ZY2KV.js").then((m5) => m5.wast());
    }
  }),
  LanguageDescription.of({
    name: "XML",
    ...
    load() {
      return import("./dist-R27FK642.js").then((m5) => m5.xml());
    }
  }),
  ...
  LanguageDescription.of({
    ...
    extensions: ["vue"],
    load() {
      return import("./dist-WVEIFLQO.js").then((m5) => m5.vue());
    }
  }),
  LanguageDescription.of({
    name: "Angular Template",
    load() {
      return import("./dist-DVF4VCPI.js").then((m5) => m5.angular());
    }
  })
];
...
// node_modules/md-editor-v3/lib/es/chunks/index.mjs
var Ae = (e4, a2) => {
  const l2 = inject("editorId"), { noImgZoomIn: t3 } = e4, n3 = M(() => {
...
var Be = (e4, a2) => {
  const l2 = inject("editorId"), t3 = inject("usedLanguageText"), n3 = inject("customIcon"), r4 = () => {
    document.querySelectorAll(`#${l2}-preview pre`).forEach((u2) => {
      ...
      const o2 = ((v2 = t3.value.copyCode) == null ? void 0 : v2.text) || "复制代码", d3 = document.createElement("span");
      d3.setAttribute("class", "copy-button"), d3.dataset.tips = o2, d3.innerHTML = Re("copy", n3.value), d3.addEventListener("click", () => {
        var y2, w2;
        clearTimeout(s3);
        const m5 = u2.querySelector("code").innerText, h6 = (0, import_copy_to_clipboard.default)(e4.formatCopiedText(m5)), f3 = ((y2 = t3.value.copyCode) == null ? void 0 : y2.successTips) || "已复制！", k3 = ((w2 = t3.value.copyCode) == null ? void 0 : w2.failTips) || "已复制！";
        d3.dataset.tips = h6 ? f3 : k3, s3 = window.setTimeout(() => {
          d3.dataset.tips = o2;
        }, 1500);
      }), u2.appendChild(d3);
    });
      ...
      if (!e4.noMermaid && n3.value) {
        ...
        d3 > 0 && document.body.appendChild(o2), s3.forEach(async (b4) => {
          ...
          if (!v2) {
            ...
            v2 = typeof k3 == "string" ? k3 : k3.svg, i4.set(b4.innerText, v2);
          }
          const m5 = document.createElement("p");
          m5.className = `${a}-mermaid`, m5.setAttribute("data-processed", ""), m5.innerHTML = v2, b4.dataset.line !== void 0 && (m5.dataset.line = b4.dataset.line), b4.replaceWith(m5), --d3 === 0 && o2.remove();
        });
      }
    });
  } };
...
var We = (e4, a2) => {
  ...
  return l2 === -1 ? (a2 || (e4.pending += "$"), e4.pos = i4, true) : l2 - i4 === 0 ? (a2 || (e4.pending += "$$"), e4.pos = i4 + 1, true) : (n3 = J(e4, l2), n3.can_close ? (a2 || (t3 = e4.push("math_inline", "math", 0), t3.markup = "$", t3.content = e4.src.slice(i4, l2)), e4.pos = l2 + 1, true) : (a2 || (e4.pending += "$"), e4.pos = i4, true));
};
var Ke = (e4, a2, l2, t3) => {
...
var qe = (e4, a2) => {
  ...
  e4.inline.ruler.after("escape", "math_inline", We), e4.block.ruler.after("blockquote", "math_block", Ke, {
  ...
  e4.block.ruler.before(
    ...
    (o2, d3, b4, v2) => {
      ...
      if (n3 !== o2.src.charCodeAt(y2))
        return false;
      for (m5 = y2 + 1; m5 <= w2 && t3[(m5 - y2) % r4] === o2.src[m5]; m5++)
        ;
      ...
      const N2 = o2.parentType, se = o2.lineMax;
      return o2.parentType = "root", o2.lineMax = h6, f3 = o2.push("admonition_open", "div", 1), f3.markup = E2, f3.block = true, f3.info = i4, f3.map = [d3, h6], f3 = o2.push("admonition_title_open", "p", 1), f3.markup = E2 + " " + i4, f3.map = [d3, h6], f3 = o2.push("inline", "", 0), f3.content = c2, f3.map = [d3, o2.line - 1], f3.children = [], f3 = o2.push("admonition_title_close", "p", -1), f3.markup = E2 + " " + i4, o2.md.block.tokenize(o2, d3 + 1, h6), f3 = o2.push("admonition_close", "div", -1), f3.markup = o2.src.slice(y2, m5), f3.block = true, o2.parentType = N2, o2.lineMax = se, o2.line = h6 + (k3 ? 1 : 0), true;
    },
    {
      alt: ["paragraph", "reference", "blockquote", "list"]
    }
...
var et = (e4, a2) => {
  ...
  const u2 = (s3, o2, d3, b4, v2) => {
    ...
    for (let T4 = o2; T4 < s3.length && (f3 = s3[T4], [k3, y2] = i4(f3), k3 === m5); T4++)
...
var ot = (e4, a2) => {
  const { editorConfig: l2, markdownItConfig: t3, markdownItPlugins: n3 } = l, r4 = inject("editorId"), i4 = inject("showCodeRowNumber"), c2 = inject("theme"), u2 = ref([]), s3 = Oe(e4), o2 = De(e4), { reRenderRef: d3, replaceMermaid: b4 } = je(e4), v2 = (0, import_markdown_it.default)({
    html: true,
    breaks: true
  });
  t3(v2);
  ...
  e4.noMermaid || m5.push({
    ...
    v2.use(w2.plugin, w2.options);
  }), v2.set({
    highlight: (w2, I3) => {
      let E2;
      !e4.noHighlight && s3.value ? s3.value.getLanguage(I3) ? E2 = s3.value.highlight(w2, {
        language: I3,
        ignoreIllegals: true
      }).value : E2 = s3.value.highlightAuto(w2).value : E2 = v2.utils.escapeHtml(w2);
      const T4 = i4 ? w(E2.replace(/^\n+|\n+$/g, "")) : `<span class="code-block">${E2.replace(/^\n+|\n+$/g, "")}</span>`;
      return `<pre><code class="language-${I3}" language=${I3}>${T4}</code></pre>`;
    }
  }), nt(v2);
  const h6 = ref(e4.sanitize(v2.render(e4.modelValue))), f3 = () => {
    C.emit(r4, S, h6.value), e4.onHtmlChanged(h6.value), e4.onGetCatalog(u2.value), C.emit(r4, I2, u2.value), b4();
  };
  onMounted(f3);
  const k3 = M(
    async () => {
      u2.value = [], h6.value = e4.sanitize(v2.render(e4.modelValue)), f3();
    },
    (l2 == null ? void 0 : l2.renderDelay) !== void 0 ? l2 == null ? void 0 : l2.renderDelay : a2 ? 0 : 500
  ), y2 = computed(() => (e4.noKatex || o2.value) && (e4.noHighlight || s3.value));
...
var at = defineComponent({
  ...
  setup(e4) {
    ...
    return Le(e4, n3), Me(e4, n3), () => createVNode(Fragment, null, [createVNode("div", {
...
var $t = (e4) => {
  ...
  onMounted(() => {
    ...
    v2.src = ((k3 = t3 == null ? void 0 : t3.prettier) == null ? void 0 : k3.standaloneJs) || d.main, v2.id = `${a}-prettier`, m5.src = ((y2 = t3 == null ? void 0 : t3.prettier) == null ? void 0 : y2.parserMarkdownJs) || d.markdown, m5.id = `${a}-prettierMD`;
    const h6 = document.createElement("link");
    h6.rel = "stylesheet", h6.href = ((w2 = t3 == null ? void 0 : t3.cropper) == null ? void 0 : w2.css) || h2.css, h6.id = `${a}-cropperCss`;
    const f3 = document.createElement("script");
    f3.src = ((I3 = t3 == null ? void 0 : t3.cropper) == null ? void 0 : I3.js) || h2.js, f3.id = `${a}-cropper`, i4 || (h4(h6), h4(f3)), n3 || h4(v2), r4 || h4(m5);
  }), le(e4);
};
var Ct = (e4, a2) => {
...
var R3 = it;
R3.install = (e4) => (e4.component(R3.name, R3), e4);
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        onClick: (s3) => {
          ...
          if (d3 && e4) {
            let t3 = d3.offsetParent, c2 = d3.offsetTop;
            if (e4.contains(t3))
              for (; t3 && e4 != t3; )
                c2 += t3 == null ? void 0 : t3.offsetTop, t3 = t3 == null ? void 0 : t3.offsetParent;
            e4 == null || e4.scrollTo({
              top: c2 - p3,
              behavior: "smooth"
            });
      ...
      }, [o2.children && o2.children.map((s3) => createVNode(C3, {
        mdHeadingId: i4,
        key: `${o2.text}-link-${s3.level}-${s3.text}`,
        tocItem: s3,
        scrollElement: n3,
        onClick: u2,
        scrollElementOffsetTop: p3
...
var P2 = defineComponent({
  ...
  setup(l2, o2) {
        ...
        if (e4.length === 0)
          ...
          if (a2.level > r4.level)
            for (let m5 = r4.level + 1; m5 <= 6; m5++) {
              ...
              if (r4 = v2[v2.length - 1], a2.level <= r4.level) {
                v2.push(a2);
                break;
              }
            }
    ...
    }), s3 = () => n3.scrollElement instanceof HTMLElement ? n3.scrollElement : document.querySelector(n3.scrollElement), g4 = L((e4) => {
      if (e4.length === 0)
    ...
    return onMounted(() => {
      var t3;
      const e4 = s3();
      (t3 = e4 === document.documentElement ? window : e4) == null || t3.addEventListener("scroll", d3), C.on(i4, {
        name: I2,
        callback: (c2) => {
          g4(c2);
        }
      ...
      var t3;
      const e4 = s3();
      (t3 = e4 === document.documentElement ? window : e4) == null || t3.removeEventListener("scroll", d3);
    }), () => createVNode("div", {
      ...
      onClick: (t3, c2) => {
        l2.onClick ? l2.onClick(t3, c2) : o2.emit("onClick", t3, c2);
      },
...
var Ll = (e4) => {
  ...
  const a2 = (w2 = (h6 = l.editorExtensions) == null ? void 0 : h6.screenfull) == null ? void 0 : w2.js, i4 = ref(false), r4 = (C4) => {
    if (!l2) {
      C.emit(o2, b2, {
        name: "fullscreen",
    ...
    l2.isEnabled ? (i4.value = true, (C4 === void 0 ? !l2.isFullscreen : C4) ? l2.request() : l2.exit()) : console.error("browser does not support screenfull!");
  }, m5 = () => {
  ...
  return onMounted(() => {
    if (m5(), !l2) {
      ...
      C4.src = a2 || g, C4.onload = g4, C4.id = `${a}-screenfull`, h4(C4, "screenfull");
    }
  }), onMounted(() => {
    C.on(o2, {
      name: A,
...
var Ol = defineComponent({
  ...
  setup(e4) {
    ...
    let a2 = (C4 = (w2 = (h6 = l) == null ? void 0 : h6.editorExtensions) == null ? void 0 : w2.cropper) == null ? void 0 : C4.instance;
          ...
          return [createVNode("div", {
            ...
            onClick: () => {
              if (u2) {
                ...
                C.emit(l2, H, [O(b4.toDataURL("image/png"))], e4.onOk), s3();
              }
            }
...
var Rl = defineComponent({
  ...
  setup(e4) {
    ...
    const C4 = computed(() => {
      const b4 = e4.toolbars.filter((I3) => !e4.toolbarsExclude.includes(I3)), p3 = b4.indexOf("="), T4 = p3 === -1 ? b4 : b4.slice(0, p3 + 1), S2 = p3 === -1 ? [] : b4.slice(p3, Number.MAX_SAFE_INTEGER);
      return [T4, S2];
    }), d3 = ref(), k3 = () => {
    ...
    const f3 = (b4) => {
      var p3, T4, S2, I3, D2, oe, ae2, M3, L4, _3, W, O2, N2, B2, V, K, j2, de, ne, J2, Z, ie2, X, F4, R4, re2, me, Ae2, Me2, Le2, Ie, De2, Ee, He2, Ne2, Be2, Oe2, Ve2, Fe, Re2, Pe, We2, Ue2, _e2, qe2, ze2, Ge2, Ke2, je2, Ze2, Xe2, Ye2, Je2, Qe2, et2, tt2, lt2, ot2, at2, nt2, it2, rt2, st, ct, ut, dt, mt;
      if (m.includes(b4))
        switch (b4) {
          case "-":
          ...
          case "bold":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (p3 = l2.value.toolbarTips) == null ? void 0 : p3.bold,
              onClick: () => {
                s3("bold");
              }
            }, [createVNode(C2, {
          ...
          case "strikeThrough":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (ae2 = l2.value.toolbarTips) == null ? void 0 : ae2.strikeThrough,
              onClick: () => {
                s3("strikeThrough");
              }
            }, [createVNode(C2, {
          ...
          case "title":
            return createVNode(F, {
              ...
              }, [(N2 = l2.value.titleItem) == null ? void 0 : N2.h5]), createVNode("li", {
                class: `${a}-menu-item ${a}-menu-item-title`,
                onClick: () => {
                  s3("h6");
                }
              ...
              default: () => {
                ...
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = l2.value.toolbarTips) == null ? void 0 : $.title
                }, [createVNode(C2, {
                  name: "title"
                }, null), e4.showToolbarName && createVNode("div", {
                  class: `${a}-toolbar-item-name`
          ...
          case "quote":
            return createVNode("div", {
              ...
              class: `${a}-toolbar-item-name`
            }, [(J2 = l2.value.toolbarTips) == null ? void 0 : J2.quote])]);
          case "unorderedList":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
          ...
          case "orderedList":
            return createVNode("div", {
              ...
              class: `${a}-toolbar-item-name`
            }, [(F4 = l2.value.toolbarTips) == null ? void 0 : F4.orderedList])]);
          case "task":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (R4 = l2.value.toolbarTips) == null ? void 0 : R4.task,
              onClick: () => {
                s3("task");
              }
            }, [createVNode(C2, {
          ...
          case "codeRow":
            return createVNode("div", {
              ...
              class: `${a}-toolbar-item-name`
            }, [(Ae2 = l2.value.toolbarTips) == null ? void 0 : Ae2.codeRow])]);
          case "code":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
          ...
          case "image":
            return e4.noUploadImg ? createVNode("div", {
              ...
              class: `${a}-toolbar-item-name`
            }, [(He2 = l2.value.toolbarTips) == null ? void 0 : He2.image])]) : createVNode(F, {
              relative: `#${m5}`,
              visible: u2.image,
              onChange: ($) => {
                u2.image = $;
              ...
              default: () => {
                ...
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = l2.value.toolbarTips) == null ? void 0 : $.image
                }, [createVNode(C2, {
                  name: "image"
                }, null), e4.showToolbarName && createVNode("div", {
                  class: `${a}-toolbar-item-name`
          ...
          case "table":
            return createVNode(F, {
              ...
              default: () => {
                ...
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = l2.value.toolbarTips) == null ? void 0 : $.table
                }, [createVNode(C2, {
                  name: "table"
                }, null), e4.showToolbarName && createVNode("div", {
                  class: `${a}-toolbar-item-name`
          ...
          case "revoke":
            return createVNode("div", {
              ...
              class: `${a}-toolbar-item-name`
            }, [(Fe = l2.value.toolbarTips) == null ? void 0 : Fe.revoke])]);
          case "next":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
          ...
          case "mermaid":
            return createVNode(F, {
              ...
              }, [(ct = l2.value.mermaid) == null ? void 0 : ct.relationship]), createVNode("li", {
                class: `${a}-menu-item ${a}-menu-item-mermaid`,
                onClick: () => {
                  s3("journey");
                }
              ...
              default: () => {
                ...
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = l2.value.toolbarTips) == null ? void 0 : $.mermaid
                }, [createVNode(C2, {
                  name: "mermaid"
                }, null), e4.showToolbarName && createVNode("div", {
                  class: `${a}-toolbar-item-name`
          ...
          case "katex":
            return createVNode(F, {
              ...
              default: () => {
                ...
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = l2.value.toolbarTips) == null ? void 0 : $.katex
                }, [createVNode(C2, {
                  name: "formula"
                }, null), e4.showToolbarName && createVNode("div", {
                  class: `${a}-toolbar-item-name`
        ...
        const $ = e4.defToolbars.children[b4];
        return $ ? cloneVNode($, {
          theme: a2.value,
          language: i4.value,
          insert(ke) {
    ...
    return watch(() => e4.toolbars, () => {
      ...
      const b4 = C4.value[0].map((T4) => f3(T4)), p3 = C4.value[1].map((T4) => f3(T4));
...
var Wl = (e4, o2, l2) => {
  const { view: a2 } = l2, i4 = T(), r4 = (C4) => a2.lineBlockAt(a2.state.doc.line(C4).from).top, m5 = (C4) => a2.lineBlockAt(a2.state.doc.line(C4).from).height;
  let g4 = [];
  const u2 = () => {
    g4 = [];
    const C4 = Array.from(o2.querySelectorAll("[data-line]")).map(
      (b4) => Number(b4.dataset.line) + 1
    ), { lines: d3 } = a2.state.doc;
    let k3 = 1, f3 = C4.shift() ?? d3;
    for (let b4 = 1; b4 <= d3; b4++)
      b4 === f3 && (k3 = b4, f3 = C4.shift() || d3 + 1), g4.push({
        start: k3,
        end: f3 - 1
      });
  };
  ...
  const w2 = L((C4) => {
    ...
    if (C4.target === e4) {
      ...
      const W = r4(M3.start), O2 = o2.querySelector(`[data-line="${M3.start - 1}"]`) || ((T4 = o2.firstElementChild) == null ? void 0 : T4.firstElementChild), N2 = o2.querySelector(`[data-line="${M3.end}"]`) || ((S2 = o2.lastElementChild) == null ? void 0 : S2.lastElementChild);
      let B2 = 0, V = 0;
      W === 0 ? O2 === N2 ? (f3 = 0, L4 = a2.contentDOM.offsetHeight - a2.scrollDOM.offsetHeight, _3 = a2.scrollDOM.scrollTop / L4, B2 = N2.offsetTop + N2.offsetHeight - o2.clientHeight) : (_3 = a2.scrollDOM.scrollTop / L4, B2 = N2.offsetTop) : L4 > a2.scrollDOM.scrollHeight - a2.scrollDOM.clientHeight ? (_3 = (a2.scrollDOM.scrollTop - W) / (a2.scrollDOM.scrollHeight - a2.scrollDOM.clientHeight - W), V = O2.offsetTop, B2 = o2.scrollHeight - o2.clientHeight - V + 10) : (_3 = (a2.scrollDOM.scrollTop - W) / (L4 - W), V = O2.offsetTop, B2 = N2.offsetTop - V);
      const K = V - f3 + B2 * _3;
      i4(o2, K, () => {
        s3--;
      });
      ...
      for (let F4 = W; F4 >= 0; F4--) {
        const R4 = o2.querySelector(`[data-line="${F4}"]`);
        if (R4 && R4.offsetTop <= L4) {
          O2 = R4, W = F4;
          break;
        }
      }
      let N2 = (D2 = o2.firstElementChild) == null ? void 0 : D2.firstElementChild, B2 = (oe = o2.firstElementChild) == null ? void 0 : oe.lastElementChild;
      for (; M3.length > 0; ) {
        const F4 = M3.indexOf(O2);
        if (F4 + 1 >= M3.length)
          break;
        const R4 = M3[F4 + 1];
        if (F4 === -1) {
      ...
      const V = N2.offsetTop;
      let K = B2.offsetTop, j2 = 0;
      const { start: de, end: ne } = g4[Number(N2.dataset.line || 0)], J2 = r4(de);
      let Z = r4(ne);
      const ie2 = m5(ne);
      let X = 0;
      N2 === ((ae2 = o2.firstElementChild) == null ? void 0 : ae2.firstElementChild) ? (N2 === B2 ? (K = B2.offsetHeight - o2.offsetHeight + f3 + b4, X = a2.contentDOM.offsetHeight - a2.scrollDOM.offsetHeight) : X = Z + ie2 - J2, j2 = Math.max(L4 / K, 0)) : Z > a2.scrollDOM.scrollHeight - a2.scrollDOM.clientHeight ? (j2 = Math.max(
        (L4 - V) / (o2.scrollHeight - V - o2.clientHeight),
        0
      ), Z = r4(a2.state.doc.lines) + m5(a2.state.doc.lines), X = 8 + Z - J2 - e4.clientHeight) : (j2 = Math.max(
        (L4 - V) / (K - V),
        0
      ), X = Z + ie2 - J2), i4(e4, J2 + X * j2, () => {
        h6--;
      });
    }
  }, 10);
...
var _l = Ul;
var ql = (e4, o2, l2) => {
  var h6, w2, C4, d3, k3, f3;
  let a2 = "", i4 = 0, r4 = 0, m5 = true, g4 = false;
  const u2 = o2.getSelectedText(), s3 = (h6 = l.editorConfig) == null ? void 0 : h6.mermaidTemplate;
  if (/^h[1-6]{1}$/.test(e4)) {
    const b4 = e4.replace(/^h(\d)/, (p3, T4) => new Array(Number(T4)).fill("#", 0, T4).join(""));
    a2 = `${b4} ${u2}`, i4 = b4.length + 1;
  } else if (e4 === "prettier") {
    const b4 = window.prettier || ((C4 = (w2 = l.editorExtensions) == null ? void 0 : w2.prettier) == null ? void 0 : C4.prettierInstance), p3 = [
    ...
    !b4 || p3[0] === void 0 ? (C.emit(l2.editorId, b2, {
      name: "prettier",
    ...
    switch (e4) {
      ...
      case "code": {
        const b4 = l2.text || u2 || "", p3 = l2.mode || "language";
        a2 = `\`\`\`${p3}
${b4}
\`\`\`
`, i4 = 3, r4 = 3 + p3.length - a2.length;
        break;
      }
      case "table": {
        a2 = "|";
        const { selectedShape: b4 = { x: 1, y: 1 } } = l2, { x: p3, y: T4 } = b4;
...
|`;
      ...
      case "link": {
        const { desc: b4, url: p3 } = l2;
        a2 = `[${b4}](${p3})`, m5 = false;
        break;
      }
      case "image": {
        const { desc: b4, url: p3, urls: T4 } = l2;
        T4 instanceof Array ? a2 = T4.reduce((S2, I3) => S2 + `![${b4}](${I3})
`, "") : a2 = `![${b4}](${p3})
`, m5 = false;
        break;
      }
...
`, i4 = 3, r4 = -4;
      ...
      case "universal": {
        const { generate: b4 } = l2, p3 = b4(u2);
        a2 = p3.targetValue, m5 = p3.select, i4 = p3.deviationStart, r4 = p3.deviationEnd;
      }
    }
  return {
    text: a2,
...
var go = HighlightStyle.define([
  ...
  { tag: [tags.name, tags.deleted, tags.character, tags.propertyName, tags.macroName], color: $t2 },
  ...
  { tag: [tags.definition(tags.name), tags.separator], color: ue },
  {
    tag: [
      tags.typeName,
      tags.className,
  ...
  { tag: tags.heading, fontWeight: "bold", color: $t2 },
...
var po = (e4, o2) => [
  ...
  },
  {
    key: "Ctrl-s",
    mac: "Cmd-s",
    run: (I3) => (C.emit(e4, E, I3.state.doc.toString()), true),
  ...
  },
  {
    ...
    any(I3, D2) {
      return (D2.ctrlKey || D2.metaKey) && D2.altKey && D2.code === "KeyC" ? (C.emit(e4, G, "codeRow"), true) : false;
    }
  },
  {
    key: "Ctrl-l",
  ...
  {
    any: (I3, D2) => (D2.ctrlKey || D2.metaKey) && D2.altKey && D2.shiftKey && D2.code === "KeyT" ? (C.emit(e4, G, "table"), true) : false
  }
];
var $o = po;
var yo = (e4) => {
  const o2 = inject("tabWidth"), l2 = inject("editorId"), a2 = inject("theme"), i4 = ref(), r4 = shallowRef(), m5 = new Compartment(), g4 = new Compartment(), u2 = new Compartment(), s3 = $o(l2, e4), h6 = vo(e4), w2 = [
  ...
  return onMounted(() => {
    ...
    r4.value = k3, setTimeout(() => {
      ...
      callback(f3, b4 = {}) {
        var S2;
        const { text: p3, options: T4 } = ql(f3, r4.value, b4);
        (S2 = r4.value) == null || S2.replaceSelectedText(p3, T4, l2);
      }
    });
  }), watch(
    a2,
    () => {
      ...
      (d3 = r4.value) == null || d3.view.dispatch({
        effects: g4.reconfigure(a2.value === "light" ? St2 : pt)
      });
    },
    {
      deep: true
...
var ye = No;
ye.install = (e4) => (e4.component(ye.name, ye), e4.use(e3).use(y).use(i3).use(k2).use(R3), e4);
